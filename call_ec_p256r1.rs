...
extern "C" {
    ...
    #[no_mangle]
    fn compute_kP_p256r1(X: *mut ac, K: *const bn256, P: *const ac)
     -> libc::c_int;
    #[no_mangle]
    fn compute_kG_p256r1(X: *mut ac, K: *const bn256) -> libc::c_int;
    #[no_mangle]
    fn ecdsa_p256r1(r: *mut bn256, s: *mut bn256, z: *const bn256,
                    d: *const bn256);
    #[no_mangle]
    fn check_secret_p256r1(q: *const bn256, d1: *mut bn256) -> libc::c_int;
}
...
#[no_mangle]
pub unsafe extern "C" fn ecdsa_sign_p256r1(mut hash: *const uint8_t,
 ...
 -> libc::c_int {
    ...
    ecdsa_p256r1(r.as_mut_ptr(), s.as_mut_ptr(), z.as_mut_ptr(),
                 d.as_mut_ptr());
...
#[no_mangle]
pub unsafe extern "C" fn ecc_compute_public_p256r1(mut key_data:
                                                       *const uint8_t)
 -> *mut uint8_t {
    ...
    if compute_kG_p256r1(q.as_mut_ptr(), k.as_mut_ptr()) < 0 as libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ecdh_decrypt_p256r1(mut input: *const uint8_t,
                                             mut output: *mut uint8_t,
                                             mut key_data: *const uint8_t)
 -> libc::c_int {
    let mut k: [bn256; 1] = [bn256{word: [0; 8],}; 1];
    ...
    r = compute_kP_p256r1(X.as_mut_ptr(), k.as_mut_ptr(), P.as_mut_ptr());
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn ecc_check_secret_p256r1(mut d0: *const uint8_t,
                                                 mut d1: *mut uint8_t)
 -> libc::c_int {
    return check_secret_p256r1(d0 as *const bn256, d1 as *mut bn256);
}
/*
